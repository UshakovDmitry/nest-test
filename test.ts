у меня есть вот такой компонент для отображения инпута для дальнейшей реализации поиска
...
и есть страница где он используется 
я хочу выводить на экран страницы то что ввожу в поиске 
реализуй это 
какие проспы и функции я должен передать 
