...
при первом клике она отображает выбранные элементы а при повторном снимает эту логику 

это работает корректно только когда 'Все города'

в других случаях ломается логика 
